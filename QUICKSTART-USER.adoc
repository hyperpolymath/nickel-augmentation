...
// Replace nickel-augmentation, Nickel Augmentation — See README.adoc for details., just run, Nickel Augmentation started successfully. with actuals
= nickel-augmentation — Quick Start for Users
:toc:
:toclevels: 2

== What is nickel-augmentation?

Nickel Augmentation — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./nickel-augmentation-portable
----
...
[source]
----
Nickel Augmentation started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/nickel-augmentation/wiki
