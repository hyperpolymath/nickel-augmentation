...
All notable changes to `nickel-augmentation` will be documented in this file.
...
- feat: nickel-augmentation 1.0.0 — proven bridge, K9 signatures, 48 tests
...
- feat: add Nickel contract library, config-reporter CLI, and wire Justfile
...
- fix(ci): sync hypatia-scan.yml to canonical (kill cd-scanner build drift) (#8)
