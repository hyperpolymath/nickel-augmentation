...
git clone https://github.com/hyperpolymath/nickel-config-reporter.git cd
...
toolbox create nickel-config-reporter-dev toolbox enter
nickel-config-reporter-dev # Install dependencies manually
...
nickel-config-reporter/ ├── src/ # Source code (Perimeter 1-2) ├── lib/
