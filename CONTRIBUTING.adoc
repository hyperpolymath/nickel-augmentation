...
git clone https://github.com/hyperpolymath/nickel-augmentation.git cd
nickel-augmentation
...
toolbox create nickel-augmentation-dev toolbox enter
nickel-augmentation-dev # Install dependencies manually
...
nickel-augmentation/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ #
