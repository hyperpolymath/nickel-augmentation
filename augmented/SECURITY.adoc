...
[arabic]
. Navigate to
https://github.com/hyperpolymath/nickel-augmentation/security/advisories/new[Report
a Vulnerability]
...
* This repository (`+hyperpolymath/nickel-augmentation+`) and all its
code
...
https://github.com/hyperpolymath/nickel-augmentation/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/nickel-augmentation/discussions[GitHub
Discussions]
...
_Thank you for helping keep Nickel Augmentation and its users safe._ 🛡️
