...
# Contributing — nickel-augmentation

## Audience

Developers working **on** `nickel-augmentation`. For consumers (people
...
``` bash
git clone git@github.com:hyperpolymath/nickel-augmentation.git
...
- Bugs in `nickel-augmentation`: file at
  `hyperpolymath/nickel-augmentation/issues`.
